...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!sms_is_valid_student_number($old['student_number'])) {
        $message = "Invalid student number format. Please enter exactly 10 digits.";
        $messageType = "error";
        ...
        if (!$selectedCourse) {
            ...
            if ($duplicate && $duplicate['student_number'] === $old['student_number']) {
                $message = "That student number already exists. Please enter a unique 10-digit student number.";
                $messageType = "error";
  ...
  <div class="portal">
    ...
    <main class="main">
      ...
      <section class="card">
        ...
        <p>Student number is the visible school ID. The database student ID is generated automatically.</p>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input id="student_number" name="student_number" type="text" value="<?php echo old_value($old, 'student_number'); ?>" placeholder="Example: 2026123819" inputmode="numeric" pattern="[0-9]{10}" maxlength="10" title="Enter exactly 10 digits." required />
              </div>
